...
def respostas():
    ...
    if (Frase == 'Olá, tudo bem?'):
        ...
        print(Resposta)
    elif (Frase == "Tudo, e com você?"):
        Resposta = "Que bom! Estou bem também. Qual são as novidades?"
        print(Resposta)
    elif (Frase == "Você tem irmãos?"):
        Resposta = "Os repositórios de exercícios do P.  satoshi!"
        print(Resposta)
    elif (Frase == "Em que dia você nasceu?"):
        Resposta = "No primeiro dia de abril de 2026! Fui projetado pelo meu desenvolvedor durante o almoço dele :D"
        print(Resposta)
    elif (Frase == "Fale uma palavra em inglês."):
        Resposta = "Feijão com farinha! (Meme em 2026)"
        print(Resposta)
